  ...
  return (
    <header id="main-header" className="relative z-30 w-full flex items-center justify-between px-6 sm:px-10 lg:px-14 py-6 md:py-8 select-none">
      ...
      <div className="flex items-center space-x-4 sm:space-x-6">
        ...
        >
          <span className="relative z-10 font-sans text-[11px] sm:text-xs tracking-[0.18em] font-medium text-slate-200 group-hover:text-white uppercase transition-colors cursor-pointer">
            Risk-Free Trial
          </span>
